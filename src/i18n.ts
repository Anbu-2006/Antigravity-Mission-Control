...
const en: Translations = {
    welcomeMessage: '🚀 Anbutech Mission Control installed successfully! Check the UFO icon in the status bar.',
    openPanel: 'Open Panel',
    loading: 'Loading...',
    loadingTooltip: 'Loading Anbutech account information...',
    noAccount: 'No Account',
    loginTooltip: 'Click to login or add Anbutech account',
    ...
    continue: 'Continue',
    cancel: 'Cancel',
    switchingAccount: 'Switching Anbutech Account',
    ...
    dashboardTitle: 'Anbutech Mission Control',
    ...
    envDiagnoseTitle: '## Anbutech Mission Control Environment Check Report\n',
    ...
    dbSection: '### 2. Anbutech IDE Database',
    exeSection: '### 3. Anbutech IDE Executable',
