...
<div class="cockpit">
    ...
    <div class="bento-layout">
        <div class="bento-left">
            ...
            <!-- Global Traffic Network (Moved to Left Bottom) -->
            <div class="bento-card traffic-network" id="trafficNetwork">
                <div class="card-title">GLOBAL TRAFFIC STATUS</div>
                <div class="traffic-list" id="trafficStatusList">
                    <!-- Populated via JS -->
                </div>
            </div>
        </div>
